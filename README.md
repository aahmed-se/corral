...
- Multi-select with click, Cmd/Ctrl-click, Shift-ranges, Cmd/Ctrl-A for every visible result, and one-click expansion to matching base URLs directly in the current folder (not its descendants).
